...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  return opsData({ email: context.email }, context.headers);
}
...
export default function OperationsLayout({ loaderData }: { loaderData: { email: string } }) {
  return <OpsShell email={loaderData.email}><Outlet/></OpsShell>;
}
